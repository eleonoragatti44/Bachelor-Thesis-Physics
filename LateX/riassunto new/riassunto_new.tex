...
\usepackage[headheight=20mm, width=150mm,top=23mm,bottom=23mm,left=29mm,right=29mm]{geometry}
\usepackage{pdf14}
...
[così in generale fa pensare ad un criterio per stimare la bontà dei software di simulazione. Lo direi in seconda battuta, dopo che hai detto che hai indagato metodi alternativi per la stima dei parametri del DrR. anche la frase che viene dopo, non fa capire il passaggio logico in cui hai deciso di utilizzare un "metodo alternativo" ad un simulatore, accettando il limite di predirre alcuni parametri e non l'intera funzione gamma(theta, phi).
Quindi specificherei meglio, dicendo poi che hai indagato l'interpolazione e la rete neurale quali metodi "alternativi al simulatore"...]
\end{comment}
