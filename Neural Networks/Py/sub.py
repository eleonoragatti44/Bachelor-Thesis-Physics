...
subprocess.run(['python', 'Test3LSig.py', "e", "fwhm_x", "fwhm_y", "co_max", "cx_max"])
subprocess.run(['python', 'Test2LSig.py', "e", "fwhm_x", "fwhm_y", "co_max", "cx_max"])
#subprocess.run(['python', 'Test1LSig.py', "e", "fwhm_x", "fwhm_y", "co_max", "cx_max"])

#subprocess.run(['python', 'Test1LTanh.py', "e", "fwhm_x", "fwhm_y", "co_max", "cx_max"])
subprocess.run(['python', 'Test2LTanh.py', "e", "fwhm_x", "fwhm_y", "co_max", "cx_max"])
